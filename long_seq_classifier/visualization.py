...
def plot_embeddings_2d(embedding_umap_2d, labels, save_path="umap_2d.png"):
    """
    Visualize embeddings in 2D using UMAP, colored by their labels.
...
def plot_embeddings_3d(embedding_umap_3d, labels, save_path="umap_3d.png"):
    """
    Visualize embeddings in 3D using UMAP, colored by their labels.
...
if __name__ == "__main__":
    # Extract embeddings and labels from train_loader
    ...
    # Plot the embeddings
    plot_embeddings_2d(embedding_umap_2d, labels, save_path="umap_train_2d.png")
    plot_embeddings_3d(embedding_umap_3d, labels, save_path="umap_train_3d.png")
