...
if __name__ == "__main__":
    ...
    # Normalize data
    data[['feature1', 'feature2', 'target']] = (data[['feature1', 'feature2', 'target']] - data.mean()) / data.std()

    # Create loaders
    train_loader, val_loader = create_loaders(data, target_column='target', sequence_length=10, batch_size=10)
